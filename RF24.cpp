...
void RF24::ce(bool level)
{
  ...
  if (ce_pin != csn_pin) ce_pin.digitalWrite(level);
}
...
RF24::RF24(DigitalPin &_cepin, DigitalPin &_cspin):
...
RF24::RF24(DigitalPin &_cepin, DigitalPin &_cspin, uint32_t _spi_speed):
